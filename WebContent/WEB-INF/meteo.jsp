    ...
    <div class="row">
      <div>
      	...
      	<table class="table table-striped table-bordered table-hover" id="mydata">
			  ...
			  <tbody>
			  	<c:forEach var="i" begin="0" end="${villeFrance.size()-1}" step="1">
			  	<tr>
				    ...
				    <td><form method="post" action="ResultatMeteo">
				    		<input id="idVille" name="idVille" type="hidden" value="${villeFrance.get(i)}">
